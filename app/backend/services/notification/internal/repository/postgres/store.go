...
func (s *Store) Templates() domain.TemplateRepository { return &templateRepository{db: s.db} }
func (s *Store) Notifications() domain.NotificationRepository { return &notificationRepository{db: s.db} }
