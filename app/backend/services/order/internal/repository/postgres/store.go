...
func (s *Store) Orders() domain.OrderRepository { return &orderRepository{db: s.db} }
func (s *Store) Items() domain.OrderItemRepository { return &orderItemRepository{db: s.db} }
