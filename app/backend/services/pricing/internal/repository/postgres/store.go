...
func (s *Store) Prices() domain.PriceRepository { return &priceRepository{db: s.db} }
func (s *Store) Promotions() domain.PromotionRepository { return &promotionRepository{db: s.db} }
