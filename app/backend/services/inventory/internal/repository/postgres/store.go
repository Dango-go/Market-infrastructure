...
func (s *Store) Warehouses() domain.WarehouseRepository { return &warehouseRepository{db: s.db} }
func (s *Store) Stock() domain.StockRepository { return &stockRepository{db: s.db} }
func (s *Store) Reservations() domain.ReservationRepository { return &reservationRepository{db: s.db} }
